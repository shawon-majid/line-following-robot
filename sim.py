...
# load library
libsimx = None
libsimx = ct.cdll.LoadLibrary("remoteApi.dll")
...
c_ClearInt32Signal = ct.CFUNCTYPE(ct.c_int32, ct.c_int32, ct.POINTER(
    ct.c_char), ct.c_int32)(("simxClearInt32Signal", libsimx))
...
c_GetInt32Signal = ct.CFUNCTYPE(ct.c_int32, ct.c_int32, ct.POINTER(
    ct.c_char), ct.POINTER(ct.c_int32), ct.c_int32)(("simxGetInt32Signal", libsimx))
...
c_SetInt32Signal = ct.CFUNCTYPE(ct.c_int32, ct.c_int32, ct.POINTER(
    ct.c_char), ct.c_int32, ct.c_int32)(("simxSetInt32Signal", libsimx))
